  ...
  return (
    <div id="landing-page" className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-indigo-500/30 selection:text-white relative overflow-hidden">
      ...
      <header className="sticky top-0 z-50 bg-slate-950/70 backdrop-blur-xl border-b border-slate-900/80 shadow-[0_4px_30px_rgba(0,0,0,0.4)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3 cursor-pointer group" onClick={() => onNavigate("landing")}>
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-brand-primary via-indigo-500 to-brand-secondary flex items-center justify-center text-white font-extrabold text-xl shadow-lg shadow-indigo-600/35 group-hover:scale-105 transition-all">
              C
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-8 lg:col-span-7">
              <motion.div
                ...
                className="inline-flex items-center space-x-2.5 bg-indigo-950/60 border border-indigo-850 px-4 py-2 rounded-full backdrop-blur-md"
              >
                <Sparkles className="w-4 h-4 text-indigo-400 animate-pulse" />
                <span className="text-xs font-bold text-indigo-300 tracking-wider uppercase font-mono">
                  Autonomous Triage Core
                </span>
              </motion.div>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  Infrastructure & <br />
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-brand-primary via-brand-secondary to-pink-500">
                    AI-Driven Dispatch
                  </span>
                </motion.h1>
                ...
                <motion.p
                  ...
                  className="text-slate-400 text-base sm:text-lg max-w-xl leading-relaxed animate-none"
                >
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="absolute inset-0 bg-indigo-500/10 rounded-3xl blur-3xl -z-10 animate-pulse animate-none" style={{ animationDuration: "6s" }}></div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-slate-900/40 p-4 rounded-2xl border border-slate-850/80 hover:border-indigo-900/60 transition-colors space-y-3 relative overflow-hidden">
                      <div className="flex items-center justify-between">
                        <Badge variant="brand">Roads Category</Badge>
      ...
      <section className="bg-slate-950 border-y border-slate-900/80 py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-xl mx-auto mb-16 space-y-2">
            <h2 className="text-xs font-bold text-brand-primary tracking-wider uppercase font-mono">Live Operations Hub</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <motion.div whileHover={{ y: -4 }}>
              <Card variant="interactive" className="p-6 relative group h-full">
            ...
            <motion.div whileHover={{ y: -4 }}>
              <Card variant="interactive" className="p-6 relative group h-full">
                ...
                <div className="flex items-baseline space-x-2">
                  ...
                  <span className="text-xs font-bold text-emerald-400 bg-emerald-955/20 px-2 py-0.5 rounded border border-emerald-900/30 font-mono">
            ...
            <motion.div whileHover={{ y: -4 }}>
              <Card variant="interactive" className="p-6 relative group h-full">
                ...
                <div className="flex items-baseline space-x-2">
                  ...
                  <span className="text-[10px] font-extrabold text-cyan-400 bg-cyan-950/40 px-1.5 py-0.5 rounded border border-cyan-900/30 uppercase font-mono">
                    Gemini verified
                  </span>
                </div>
              </Card>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <motion.div whileHover={{ y: -5 }}>
              <Card variant="interactive" className="p-8 space-y-5 h-full">
      ...
      <section className="bg-slate-950 py-24 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[350px] bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full filter blur-[150px] opacity-10 -z-10"></div>
